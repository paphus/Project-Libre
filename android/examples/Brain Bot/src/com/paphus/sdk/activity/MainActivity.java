...
public class MainActivity extends Activity {
	 ...
	 */
	 /** ** enter you app id from your user page ** */
	 ...
	 */
	public static String launchInstanceId = "165"; // ** enter your bot's id, i.e. "171"
	public static String launchInstanceName = "Brain Bot"; // ** nter your bot's name, i.e. "Help Bot"
	
	public static String forumId = "26662"; // ** you can also add a forum
	public static String chatroomId = "356968";  // ** or a chatroom
	...
	/**
	 * Launch the predefined chatroom.
	 */
	public void launchChatroom(View view) {
		WebMediumConfig config = null;
		config = new ChannelConfig();
        config.id = chatroomId;
